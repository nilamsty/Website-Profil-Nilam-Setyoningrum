...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-info shadow p-2 mb-4 rounded">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item">
            <a class="nav-link {{ ($title === "Hubungi Saya") ? 'active' : ''}}" href="/hubungisaya">Hubungi Saya</a>
          </li>
        </ul>
      </div>
    </nav>
    ...
    <footer id="footer" class=" text-center mt-10">
      <strong>copyright©2020  || Nilam Setyoningrum-19050974047</strong>
    </footer>
